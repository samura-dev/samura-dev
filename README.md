...
<i>
Специализируюсь на создании премиальных веб-интерфейсов, сайтов, веб-сервисов, мобильных приложений и Telegram Mini Apps.<br/>
Ориентир — кибер-минимализм, сложные анимации и безупречный UX.<br/>
Работаю с хардкорным стеком, оперирую ИИ для экстремального ускорения разработки.
</i>
...
const samura = {
  ...
  location: "Russia",
  style: "Heavy Luxury × Cyber-Minimalism",
  core: "Премиальные веб-интерфейсы",
};
```
